...
describe('OptionsListUtils', () => {
    ...
    /* Testing getValidOptions with share destination configuration */
    test('[OptionsListUtils] getValidOptions with share destination config', async () => {
        await waitForBatchedUpdates();
        await measureFunction(() => getValidOptions(
