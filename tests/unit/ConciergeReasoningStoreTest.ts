import {addReasoning, clearReasoning, getReasoningHistory, subscribe} from '@libs/ConciergeReasoningStore';

describe('ConciergeReasoningStore', () => {
    // Clear the store after each test
    afterEach(() => {
        clearReasoning('report1');
        clearReasoning('report2');
        clearReasoning('report3');
    });

    describe('addReasoning', () => {
        it('should add reasoning entries for a report', () => {
            addReasoning('report1', {
                reasoning: 'Thinking about the problem...',
                agentZeroRequestID: 'request1',
                loopCount: 1,
            });

            const history = getReasoningHistory('report1');
    ...
    describe('reset on agentZeroRequestID change', () => {
        it('should reset entries when agentZeroRequestID changes', () => {
            ...
            let history = getReasoningHistory('report1');
            ...
            history = getReasoningHistory('report1');
            expect(history).toHaveLength(1);
    ...
    describe('clearing reasoning per report only', () => {
        it('should only clear reasoning for the specified report', () => {
            ...
            addReasoning('report2', {
                reasoning: 'Report 2 thought',
                agentZeroRequestID: 'request1',
                loopCount: 1,
            });
            addReasoning('report3', {
            ...
            const history1 = getReasoningHistory('report1');
            const history2 = getReasoningHistory('report2');
            const history3 = getReasoningHistory('report3');
        ...
        it('should handle clearing non-existent report gracefully', () => {
            expect(() => {
                clearReasoning('nonExistentReport');
            }).not.toThrow();
        });
    ...
    describe('getReasoningHistory', () => {
        it('should return empty array for report with no reasoning', () => {
            const history = getReasoningHistory('nonExistentReport');
        ...
        it('should return a copy of the history array', () => {
            ...
            const history1 = getReasoningHistory('report1');
            const history2 = getReasoningHistory('report1');
    ...
    describe('subscribe and unsubscribe behavior', () => {
        ...
        it('should support multiple subscribers', () => {
            ...
            const unsubscribe3 = subscribe(listener3);
