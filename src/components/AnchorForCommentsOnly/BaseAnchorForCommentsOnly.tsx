 ...
 */
function BaseAnchorForCommentsOnly({onPressIn, onPressOut, href = '', rel = '', target = '', children = null, style, onPress, hasImageInLink, ...rest}: BaseAnchorForCommentsOnlyProps) {
    ...
    return (
        ...
        >
            <Tooltip text={!hasImageInLink ? href : undefined}>
                <Text
                    ref={linkRef}
                    ...
                    href={!hasImageInLink ? href : undefined}
                    suppressHighlighting
