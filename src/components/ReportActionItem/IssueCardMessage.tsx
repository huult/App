            ...
            {shouldShowAddMissingDetailsButton && (
                <Button
                    onPress={() => {
                        Navigation.navigate(
                            createDynamicRoute(
                                DYNAMIC_ROUTES.REPORT_MISSING_PERSONAL_DETAILS.getRoute(String(expensifyCard.cardID)),
                                ROUTES.REPORT_WITH_ID.getRoute(route.params?.reportID, route.params?.reportActionID),
                            ),
                        );
                    }}
                    success
            ...
            {shouldShowActivateButton && (
                <Button
                    onPress={() => {
                        ...
                        Navigation.navigate(
                            createDynamicRoute(
                                DYNAMIC_ROUTES.REPORT_CARD_ACTIVATE.getRoute(expensifyCard.cardID),
                                ROUTES.REPORT_WITH_ID.getRoute(route.params?.reportID, route.params?.reportActionID),
                            ),
                        );
                    }}
