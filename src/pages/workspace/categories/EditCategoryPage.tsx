...
function EditCategoryPage({route}: EditCategoryPageProps) {
    ...
    const dynamicBackPath = useDynamicBackPath(DYNAMIC_ROUTES.SETTINGS_CATEGORY_EDIT.path);
    ...
    const editCategory = useCallback(
        (values: FormOnyxValues<typeof ONYXKEYS.FORMS.WORKSPACE_CATEGORY_FORM>) => {
            ...
            Navigation.setNavigationActionToMicrotaskQueue(() => {
                Navigation.goBack(isQuickSettingsFlow ? dynamicBackPath : ROUTES.WORKSPACE_CATEGORY_SETTINGS.getRoute(policyID, currentCategoryName), {compareParams: false});
            });
        },
        [isQuickSettingsFlow, currentCategoryName, dynamicBackPath, policyData, policyID],
    );
        ...
        >
            ...
            >
                <HeaderWithBackButton
                    ...
                    onBackButtonPress={() =>
                        Navigation.goBack(isQuickSettingsFlow ? dynamicBackPath : ROUTES.WORKSPACE_CATEGORY_SETTINGS.getRoute(route.params.policyID, route.params.categoryName))
                    }
                />
                <CategoryForm
