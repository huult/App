...
import {convertAmountToDisplayString, getCurrencySymbol} from '@libs/CurrencyUtils';
...
function WorkspacePerDiemDetailsPage({route}: WorkspacePerDiemDetailsPageProps) {
    ...
    const amountValue = selectedSubRate?.rate ? convertAmountToDisplayString(Number(selectedSubRate.rate), selectedRate?.currency, false) : undefined;
