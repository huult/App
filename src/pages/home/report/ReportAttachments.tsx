...
function ReportAttachments({route}: ReportAttachmentsProps) {
    ...
    const imageWithExternalLink = route.params?.imageWithExternalLink;
    ...
    const onCarouselAttachmentChange = useCallback(
        (attachment: Attachment) => {
            const routeToNavigate = ROUTES.ATTACHMENTS.getRoute(reportID, type, String(attachment.source), Number(accountID), !!isAuthTokenRequired, imageWithExternalLink);
            Navigation.navigate(routeToNavigate);
        },
        [reportID, type, accountID, isAuthTokenRequired, imageWithExternalLink],
    );
    ...
    return (
        <AttachmentModal
            ...
            imageWithExternalLink={imageWithExternalLink}
        />
    );
}
