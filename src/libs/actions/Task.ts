...
function clearOutTaskInfoAndNavigate(
    ...
    const basePath = Navigation.getReportRHPActiveRoute() || Navigation.getActiveRoute();
    Navigation.navigate(createDynamicRoute(DYNAMIC_ROUTES.NEW_TASK_DETAILS.path, basePath));
}
